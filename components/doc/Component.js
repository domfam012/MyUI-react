...
const Component = props => {
  ...
  return (
    <div className="doc-content">
      ...
      <h3 className="title-sm com-pt" id="breadcrumb">
        2. 경로(Breadcrumb)
      </h3>
      <div className="text mb-3">
      ...
      <h3 className="title-sm com-pt" id="step">
        3. 단계(Step)
      </h3>
      <div className="text mb-3">
      ...
      <h3 className="title-sm com-pt" id="slide">
        4. 슬라이드(carousel)
      </h3>
      <div className="text mb-3">
        <span>
      ...
      <h3 className="title-sm com-pt" id="card">
        6. 카드(Cards)
      </h3>
      <div className="text mb-3">
        <span>
      ...
      <h3 className="title-sm com-pt" id="form">
        7. 폼(Forms)
      </h3>
      <div className="text mb-3">
      ...
      <h3 className="title-sm com-pt" id="pagination">
        8. 페이지네이션(Pagination)
      </h3>
      <div className="text mb-3">
        <span>
      ...
      <h3 className="title-sm com-pt" id="table">
        10. 테이블(Table)
      </h3>
      <div className="text mb-3">
        <span>
      ...
      <h3 className="title-sm com-pt" id="snb">
        11. 사이드 네비게이션 바(SNB)
      </h3>
      <div className="text mb-3">
        <span>
      ...
      <h3 className="title-sm com-pt" id="navbar">
      ...
      <h3 className="title-sm com-pt" id="modal">
        13. 모달(Modal)
      </h3>
      <div className="text mb-3">
        <span>
